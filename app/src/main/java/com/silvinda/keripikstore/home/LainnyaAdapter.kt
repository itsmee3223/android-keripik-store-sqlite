...
class LainnyaAdapter(private var data: List<Keripik>,
                     private var listener: (Keripik) -> Unit) : RecyclerView.Adapter<LainnyaAdapter.LeagueViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LeagueViewHolder {
        ...
        val inflateView: View = layoutInflater.inflate(R.layout.list_product_item, parent, false)
